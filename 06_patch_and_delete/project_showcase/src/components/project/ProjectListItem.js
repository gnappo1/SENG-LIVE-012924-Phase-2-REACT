...
const ProjectListItem = ({ id, image, name, link, about, phase, handleDeleteProject, handleChangeEditingMode }) => {
    ...
    <li className="card">
      ...
      <footer className="extra">
        ...
        <div className="manage">
          <button onClick={() => handleChangeEditingMode(id)}><FaPencilAlt /></button>
